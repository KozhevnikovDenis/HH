...
namespace Quaternion
{
    public partial class Single : Form
    {
        ...
        private static double numS, numX, numY, numZ, numResultS, numResultX, numResultY, numResultZ, numResultScalar;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Quaternion q = new Quaternion(numS, numX, numY, numZ);
