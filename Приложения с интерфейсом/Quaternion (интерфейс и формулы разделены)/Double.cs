...
namespace Quaternion
{
    public partial class Double : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Quaternion q1 = new Quaternion(numS1, numX1, numY1, numZ1);
            Quaternion q2 = new Quaternion(numS2, numX2, numY2, numZ2);
            ...
            switch (btn.Name)// Переключатель
            {
                ...
                case "button4":
                    ...
                    break;
                case "button5":
                    numResultScalar = temp.ScalarProduct(q1, q2);
                    ...
                    break;
                case "button6":
                    numResultScalar = temp.Angle(q1, q2);
