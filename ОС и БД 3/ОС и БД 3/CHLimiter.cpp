...
{
	::MoveToEx(dc, this->xmin, this->y, NULL); //Перемещение позиции рисования
	::LineTo(dc, this->xmax, this->y); //метод LineTo - отриоовывает линию с текущей позиции до указанной
}
