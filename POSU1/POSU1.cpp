...
// POSU1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPOSU1App, CWinApp)
...
// Единственный объект CPOSU1App

CPOSU1App theApp;


// Инициализация CPOSU1App

BOOL CPOSU1App::InitInstance()
{
