...
// 4 in a row 9x7.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy4inarow9x7App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMy4inarow9x7App

CMy4inarow9x7App::CMy4inarow9x7App()
{
...
// Единственный объект CMy4inarow9x7App

CMy4inarow9x7App theApp;


// Инициализация CMy4inarow9x7App

BOOL CMy4inarow9x7App::InitInstance()
{
